An implementation of [parameter server](https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-li_mu.pdf) (PS) framework in [PyTorch](https://pytorch.org/). The implementation is based on Remote Procedure Call (RPC) in PyTorch.
