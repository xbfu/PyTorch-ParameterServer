...
## Implementation
This code is based on [torch.distributed.rpc](https://pytorch.org/docs/1.9.0/rpc.html). It includes one PS (rank=0) and 4 workers (rank=1,2,3,4). 
## Environments
...
## References
\[1\]. https://www.usenix.org/system/files/conference/osdi14/osdi14-paper-li_mu.pdf  
